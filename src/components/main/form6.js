...
class Form6Component extends Component {
  STEP = 6;
  state = {
    blocks: [],
    form: {},
          ...
          {config.form.showNavigation &&
            <div className="progress-block">
              <ul className="list-unstyled multi-steps">
                ...
                <li className="is-active"></li>
                <li className="camCon">
                  <svg className="gold-icon" xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16"><g><g><path fill="#c7ad3f" d="M5.818 8.556a2.738 2.738 0 1 1 5.475 0 2.738 2.738 0 0 1-5.475 0z" /></g><g><path fill="#c7ad3f" d="M8.556 12.833a4.28 4.28 0 0 1-4.278-4.278 4.28 4.28 0 0 1 4.278-4.277 4.28 4.28 0 0 1 4.277 4.277 4.28 4.28 0 0 1-4.278 4.278zM5.989 0L4.423 1.711H1.711C.77 1.711 0 2.481 0 3.422V13.69c0 .94.77 1.71 1.711 1.71H15.4c.941 0 1.711-.77 1.711-1.71V3.422c0-.94-.77-1.71-1.711-1.71h-2.712L11.122 0z" /></g></g></svg>
                </li>
              </ul>
            </div>
          }
