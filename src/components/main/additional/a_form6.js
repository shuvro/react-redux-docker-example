...
import { getAdditionalFormData, updateAdditionalFormFieldValue, redirectToUrl } from '../../../actions';
...
class AdditionalForm6Component extends Component {
  STEP = 6;
  state = {
    blocks: [],
    form: {},
  ...
  onFormSubmit = (e) => {
    ...
    if (!valid) {
      ...
      this.props.redirectToUrl(ROUTES.A_SUBMIT);
    }
  }
          ...
          {config.form.showNavigation &&
            <div className="progress-block">
              <ul className="list-unstyled multi-steps">
                <li onClick={e => this.gotoStep(e, ROUTES.A_FORM1)} ></li>
