...
import { getPartnerData, postPartnerData, updateFormFieldValue, redirectToUrl, autoPostFormData, deleteImage } from '../../actions'
...
class Partners5Component extends Component {
  STEP = 'partners';
  ...
  componentWillMount() {
      this.props.getPartnerData({ id: this.partnerId, step: this.STEP })
  }
  ...
  onFormSubmit = (e) => {
    ...
    if (!valid) {
      ...
      this.props.postPartnerData({ form: this.state.form, step: this.STEP, partnerId: this.partnerId });
    }
  }
